		...
		<div id="footer-outer">
			...
			<div id="footer-sub">
				<footer id="footer">
                  ...
                  <div style="color: #ffffff; text-align:center">© Кафедра графических информационных систем</div>
                  <table width="100%" style="border-color: transparent;">
                    <tr>
                      <td style="text-align:center">Контакты</td>
                      <td style="text-align:center">Карта сайта</td>
                      <td style="text-align:center">Обратная связь</td>
                    </tr>
                  </table>
				</footer><!-- end footer -->
			</div>
